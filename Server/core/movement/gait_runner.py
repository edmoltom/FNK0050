...
class GaitRunner:
    """Wrapper around :class:`gait_cpg.CPG` providing gait utilities."""

    def __init__(self, cpg: Optional[CPG] = None) -> None:
        #: Underlying CPG instance controlling the gait phases.
        self.cpg = cpg or CPG("walk")

    # ------------------------------------------------------------------
    def update_legs_from_cpg(self, ctrl: Any, dt: float) -> None:
    ...
    # ------------------------------------------------------------------
    def step_move(self, ctrl: Any, axis: str, mode: str, direction: str, cycles: int = 1) -> None:
        ...
        while not ctrl.stop_requested and done < cycles:
            ...
            self.update_legs_from_cpg(ctrl, dt)
            ctrl.run()
    ...
    # ------------------------------------------------------------------
    def forWard(self, ctrl: Any) -> None:  # noqa: N802
        self.step_move(ctrl, "X", "forWard", "positive")

    # ------------------------------------------------------------------
    def backWard(self, ctrl: Any) -> None:  # noqa: N802
        self.step_move(ctrl, "X", "backWard", "negative")

    # ------------------------------------------------------------------
    def stepLeft(self, ctrl: Any) -> None:  # noqa: N802
        self.step_move(ctrl, "Z", "stepLeft", "positive")

    # ------------------------------------------------------------------
    def stepRight(self, ctrl: Any) -> None:  # noqa: N802
        self.step_move(ctrl, "Z", "stepRight", "negative")

    # ------------------------------------------------------------------
    def turnLeft(self, ctrl: Any) -> None:  # noqa: N802
        self.step_move(ctrl, "W", "turnLeft", "positive")

    # ------------------------------------------------------------------
    def turnRight(self, ctrl: Any) -> None:  # noqa: N802
        self.step_move(ctrl, "W", "turnRight", "negative")

    # ------------------------------------------------------------------
    def stop(self, ctrl: Any) -> None:
        ctrl._is_turning = False
        ctrl._turn_dir = 0
        ctrl._stride_dir_x = 0
        ctrl._stride_dir_z = 0
