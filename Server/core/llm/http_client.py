"""HTTP-based implementation of the :class:`LLMClient` interface."""
...
class HTTPClient(LLMClient):
    """Query a locally hosted LLM via HTTP."""

    def query(self, messages, max_chars: int = 220) -> str:
        ...
        return postprocess(text, max_chars)
